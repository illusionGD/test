...
game.States.preload = function () {
    this.preload = function () {
        ...
        game.load.spine(
            'fen', //The key used for Phaser's cache
            './assets/plane/spine7_2_skl7_5_target_1.json' //The location of the spine's json file
        );
    }
...
game.States.start = function () {
    ...
    this.create = function () {
        ...
        // bgMusic.play()
        const fen = game.add.spine(100, 100, 'fen');
        // console.log(fen);
        fen.setAnimationByName(
            0, //Track index
            "skl7_5_target_1", //Animation's name
            true //If the animation should loop or not
        );
        // fen.setInteractive();
        // fen.onEvent.add(function (i, e) {
